...
namespace Pelias.NET.Model.Objects.Pelias.Resources {
    ...
    internal class DataAnnotationsResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The {0} field cannot only contain whitespace characters..
        /// </summary>
        internal static string TextAttribute_ValidationError {
            get {
                return ResourceManager.GetString("TextAttribute_ValidationError", resourceCulture);
            }
        }
    }
}
